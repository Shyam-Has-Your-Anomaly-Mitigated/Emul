...
* placeholder (I should have typed it out when I thought of it); maybe it was...
  * handicapped parents can have kids, but no inbreeding? if you cannot support yourself, how can you support someone else; who is ℝeally the "parent"? I think they just want someone to [boss around](https://en.wikipedia.org/wiki/Stanford_prison_experiment)... (it's like having a pet/slave animal)
