# Plan
- [ ] Haskell (Functional Programming); *Shyams' Haskell Implementation Tech* (`ghc shit.hs; shit shit.hs; shit`)
...
- [ ] Prolog (Logical Programming); *Shyams' Prolog E… Reasoning/Ratiocination/Rational/ℝeal Mæch (Machinery/Mechanism)* (`swipl sperm.pl; sperm sperm.pl; sperm`)
