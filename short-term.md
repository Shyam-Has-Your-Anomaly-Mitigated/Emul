...
*I'm just [a square](https://en.wikipedia.org/wiki/Template:Flatland)… (I think it's Pythonic Lisp; also 0D is a character, 1D is a line, 2D is multiline, 3D is multifile, and 2D visual programming is a "-thing".)*
